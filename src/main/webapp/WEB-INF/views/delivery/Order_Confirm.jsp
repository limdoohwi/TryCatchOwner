...
<link href="bootstrab_order_confirm/css/bootstrap.min.css"
	rel="stylesheet">
	...
	<div style="width: 80%; margin: auto;">
		...
		<form method="get" id="frm" class="form-inline" action="demo.html">
			...
			<label> <span>연도 </span> <select
				...
				name="Select-Material-Order-Day" id="c" class="form-control">
					<option>선택</option>
					<option>1</option>
			</select>
			</label>
			...
			<tbody>
				...
				<tr class="Address-tr">
					...
					<td><a href="#" id="group" data-type="select" data-pk="1"
						data-value="5" data-source="/groups" data-title="Select group">서울특별시
							중구 지하동 101</a></td>
				</tr>
				<tr>
					<td>계피가루</td>
		...
		<div style="display: inline-block; margin-top: 10%">
			<a class="btn btn-success">결제 완료</a>&nbsp;&nbsp;&nbsp; <a
				class="btn btn-default">결제 취소</a>
		</div>
	</div>
</body>
</html>
