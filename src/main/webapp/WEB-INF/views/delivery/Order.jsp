...
<link href="/owner/resources/bootstrab_order_confirm/css/bootstrap.min.css" rel="stylesheet">

<!-- Custom CSS -->
<link href="/owner/resources/bootstrab_order_confirm/css/freelancer.css" rel="stylesheet">
<link href="/owner/resources/bootstrab_order_confirm/css/heroic-features.css" rel="stylesheet">
<!-- Custom Fonts -->
<link href="/owner/resources/bootstrab_order_confirm/font-awesome/css/font-awesome.min.css"
...
<script src="/owner/resources/bootstrab_order_confirm/js/bootstrap.min.js"></script>

<!-- Plugin JavaScript -->
<script
	src="http://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js"></script>
<script src="/owner/resources/bootstrab_order_confirm/js/classie.js"></script>
<script src="/owner/resources/bootstrab_order_confirm/js/cbpAnimatedHeader.js"></script>

<!-- Contact Form JavaScript -->
<script src="/owner/resources/bootstrab_order_confirm/js/jqBootstrapValidation.js"></script>
...
<div class="row" style="color: black">
	...
	<div class="col-lg-offset-3">
		<div class="row">
			...
			<form id="payment_form" action="/owner/insert/materialpayment" method="post" >	
				...
				<table id="selected_option" class="table">
					...
					<c:forEach var="materialcart_material" items="${cartlist}">
						...
						<tr/>
						<input type="hidden" name="material_nos" value="${materialcart_material.material_no}"/>
						<input type="hidden" name="material_counts" value="${materialcart_material.material_count}"/>
						<c:set var="total_price" value="${total_price+materialcart_material.material_count*materialcart_material.material_price}"/>
						<c:set var="total_count" value="${total_count+materialcart_material.material_count}"/>
					</c:forEach>
					<tr>
						<td>총 계</td>
						<td>${total_count}</td>
				...
				<input type="hidden" name="material_total_price" value="${total_price}"/>
				<input type="hidden" id="select_store_hidden" name="store_no"/>
				<br/>
				...
				<button id="materialpayment_confirmbtn" class="btn btn-danger" style="margin-left:1000px;">신청하기</button>
				</div>
			</form>
		</div>
	</div>
