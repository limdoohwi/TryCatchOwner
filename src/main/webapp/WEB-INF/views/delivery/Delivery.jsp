			...
			<li>
				<div class="dropdown">
					<a id="Select-Store-Btn" href="#" data-toggle="dropdown"
						aria-haspopup="ture" aria-expanded="true">매장 선택<span
						class="caret"></span></a>
										...
										<form class="form-horizontal" method="post" action="add">
											<div style="display: inline-block;">
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input class="form-count material_cnt" placeholder="상품 수량">
													</div>
												</div>
												...
												<div class="form-group">
													<div class="col-sm-2 col-sm-offset-2">
														<button id="Cart-add-btn" type="button"
															...
															value="${coffeelist.material_no}">담기</button>
														&nbsp;&nbsp;
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="email" class="form-count material_cnt"
														id="inputEmail3" placeholder="상품 수량">
												</div>
											</div>
											<!-- 담기 button -->
											<div class="form-group">
												<div style="margin-left: 95px"
													...
													<button id="Cart-add-btn" type="button"
														class="btn btn-danger btn-cart-material"
														value="${cakelist.material_no}">담기</button>
													&nbsp;&nbsp;
												</div>
											</div>
										</form>
