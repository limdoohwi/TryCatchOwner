 ...
 *  Description: 메인 페이지에서 설정된 매장의 이번 연도 매출액을 보여주는 그래프 JSP
 *  Created: 2016­07­24
 *	Author: 김준혁
...
<script type="text/javascript">
	...
	$(function() {
		callList_Ajax("/owner/year_profit/main/chart", successCallProfitYear,null, null);
	})
	function successCallProfitYear(data) {
		...
		for(var i=0; i<category_percentage_name.length; i++){
			$("#Category-Percentage-div").append("" +
					 "<div class='col-xs-4 text-center' style='border-right: 1px solid #f4f4f4'>" +
	                 "<input type='text' class='knob' data-readonly='true' value='"+((Number(category_percentage_value[i]))/total_value) * 100+"%' data-width='60' data-height='60' data-fgColor='#39CCCC' readonly='readonly' style='color:#39CCCC; border:none'>" +
	                 "<div class='knob-label' style='font-weight:bold'>"+category_percentage_name[i]+"</div>" +
	               "</div>");
		}
	}
