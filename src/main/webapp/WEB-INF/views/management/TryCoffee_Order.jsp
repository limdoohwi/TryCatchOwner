					...
					<div class="box">
						<div class="box-header">
							...
							<div class="input-group col-sm-2" style="margin-top: 5px">
								<input type="text" name="q" id="Order-Search-Text"
									class="form-control" placeholder="주문자 입력"> <span
									class="input-group-btn">
									<button type="button" name="search" id="Order-Search-btn"
							...
							<table id="example2" class="table table-bordered table-hover">
								<thead>
									<tr>
										<th>결제 시간</th>
										<th>예약 시간 <!-- 시간 내림차순 -->
											<div id="Reservation-Time-Levle-Down" class="pull-right"
												style="display: none">
												<a data-toggle="tooltip" title="내림차순"><i
													style="cursor: pointer;" class="fa fa-level-down"
													aria-hidden="true"></i></a>
											</div> <!-- 시간 오름차순 -->
											<div id="Reservation-Time-Levle-Up" class="pull-right">
												<a data-toggle="tooltip" title="오름차순"><i
													style="cursor: pointer;" class="fa fa-level-up"
													aria-hidden="true"></i></a>
											</div>
										</th>
										<th>총 결제액</th>
